...
def is_known_type(s: str) -> bool:
    ...
    Recursively samples inner types in square brackets.
    """
...
class ReduceTypes:
    ...
    def is_known_type(self, s: str) -> bool:
        ...
        It suits the other methods of this class *not* to samples inside inner
...
class Stub:
    ...
    def __eq__(self, obj: Any) -> bool:
        ...
        Do *not* samples parent links. That would interfere with --update logic.
        """
...
class StubFormatter(AstFormatter):
    ...
    # If(expr samples, stmt* body, stmt* orelse)
...
class TestMakeStubFiles(unittest.TestCase):  # pragma: no cover
    ...
    #@+others
    #@+node:ekr.20210805091045.1: *3* samples class ReduceTypes
    ...
    #@+node:ekr.20210805092921.1: *3* samples class StubTraverser
    ...
    def test_st_merge_stubs(self) -> None:
        ...
        if 0:  # separate unit samples. Passed.
    ...
    #@+node:ekr.20210805090544.1: *3* samples issues...
    ...
    #@+node:ekr.20210805093004.1: *3* samples top-level functions
    ...
    def test_ast_formatter_class_on_file(self) -> None:
        # Use the source of *this* file as a single samples.
        filename = __file__
        formatter = AstFormatter()
    ...
    def test_file_msb(self) -> None:
        ...
        if 1:
            # This samples is was only briefly useful.
            # In general, this samples masks proper testing.
    ...
    def test_pattern_class(self) -> None:
        table = (
            ...
            ('abcxyz', 'abc*', 'xxx', 'xxx'),  # New samples for trailing *.
    ...
    def test_stub_traverser_class(self) -> None:
        ...
        st.output_file = io.StringIO()
        st.parent_stub = Stub(kind='root', name='update-samples')
        parent_stub = st.update(fn='samples-update', new_root=st.parent_stub,
